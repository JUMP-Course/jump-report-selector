    ...
    <>
      ...
      <div className="content-band">
        <Form form={form} layout="inline" initialValues={{ lesson: 1, date: dayjs(), count: 1, excluded_student_ids: [] }}>
          ...
          <Form.Item name="excluded_student_ids" label="排除学生" style={{ minWidth: 260 }}>
            <Select mode="multiple" allowClear showSearch options={students.map((s) => ({ label: `${s.name} (${s.pinyin})`, value: s.id }))} optionFilterProp="label" />
          </Form.Item>
        </Form>
